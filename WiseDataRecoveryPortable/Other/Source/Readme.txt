...
user in an INI file next to WiseDataRecoveryPortable.exe called WiseDataRecoveryPortable.ini.
...
copy AppNamePortable.ini from this directory to WiseDataRecoveryPortable.ini next to
WiseDataRecoveryPortable.exe. The options in the INI file are as follows:
